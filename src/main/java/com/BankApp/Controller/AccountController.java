...
import com.BankApp.Service.AccounntService;
...
public class AccountController {
	...
	@Autowired
	AccounntService service;
	//create the account
	@PostMapping("/create")
	public ResponseEntity<Account> createAccount(@RequestBody Account account) {
		Account createAccount=service.createAccounnt(account);
	...
	public List<Account> getAllAccountDetails(){
		List<Account> allAccountDetails=service.getAllAccounntDetails();
